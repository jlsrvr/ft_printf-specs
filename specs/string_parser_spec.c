...
int main(void)
{
	...
	dest = ft_strdup("");
	input = ft_strdup("String with no conversions");
	expected = "String with no conversions";
	converting_function_test("No conversion", &dest, input, expected);
	dest = ft_strdup("");
	input = ft_strdup("%s");
	expected = "string";;
	converting_function_test("String with only %s", &dest, input, expected, "string");
	dest = ft_strdup("");
	input = ft_strdup("%s print stuff after conversion");
	...
	dest = ft_strdup("");
	input = ft_strdup("print this before conversion of %s");
